 ...
 * Accept the audit branch's spelling, but not two ambiguous header choices. */
#if defined(BOOTLOADER_CONFIG_HEADER) && defined(STM32TOOLS_BOOT_CONFIG_HEADER)
#error "Select one Bootloader configuration header spelling, not both"
#endif
#ifdef BOOTLOADER_CONFIG_HEADER
#define STM32TOOLS_BOOT_CONFIG_HEADER BOOTLOADER_CONFIG_HEADER
#endif
