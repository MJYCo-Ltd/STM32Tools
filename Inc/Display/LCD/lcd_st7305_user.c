 ...
 *
 * 默认参数适用于 200x200 ST7305 单色反射式 LCD。更换面板时，应以面板
 * 厂商提供的初始化参数为准，尤其是电压、偏移和 Gate Line 设置。
 */
...
/* 200x200 面板参数；GRAM 实际写入宽度向上对齐到 12 像素（204 像素）。 */
#define ST7305_WIDTH          200U
#define ST7305_HEIGHT         200U
#define ST7305_COLUMN_OFFSET  0x16U
#define ST7305_ROW_OFFSET     0x00U
#define ST7305_GATE_LINES     0x32U
#define ST7305_MADCTL_VALUE   0xA4U

/* 厂商推荐的模拟电压和时序参数。 */
#define ST7305_NVM_LOAD_0     0x17U
#define ST7305_NVM_LOAD_1     0x02U
#define ST7305_GATE_VOLTAGE_0 0x12U
#define ST7305_GATE_VOLTAGE_1 0x0AU
#define ST7305_OSC_VALUE      0x80U
#define ST7305_FRAME_RATE     0x12U
#define ST7305_VSHP_VALUES    {0x73U, 0x3EU, 0x3CU, 0x3CU}
#define ST7305_VSLP_VALUES    {0x00U, 0x21U, 0x23U, 0x23U}
#define ST7305_VSHN_VALUES    {0x32U, 0x5CU, 0x5AU, 0x5AU}
#define ST7305_VSLN_VALUES    {0x32U, 0x35U, 0x37U, 0x37U}
