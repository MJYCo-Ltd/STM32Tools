...
/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			RF24L01_CE_GPIO_Port->ODR |= RF24L01_CE_Pin
#define RF24L01_SET_CE_LOW( )			RF24L01_CE_GPIO_Port->ODR &= (uint32_t)( ~(uint32_t)RF24L01_CE_Pin )

#define RF24L01_SET_CS_HIGH( )			RF24L01_CSN_GPIO_Port->ODR |= RF24L01_CSN_Pin
#define RF24L01_SET_CS_LOW( )			RF24L01_CSN_GPIO_Port->ODR &= (uint32_t)( ~(uint32_t)RF24L01_CSN_Pin)

#define RF24L01_GET_IRQ_STATUS( )		(( RF24L01_IRQ_GPIO_Port->IDR & (uint32_t)RF24L01_IRQ_Pin) != RF24L01_IRQ_Pin ) ? 0 : 1	//IRQ状态
